...
/**
 * @brief When a new image comes in, compare it all existed view templates and return the id of the best matched one. Publish the time seq and the id.
 * 
 * @param image 
 * @param pub_vt 
 */
void image_callback(sensor_msgs::ImageConstPtr image, ros::Publisher * pub_vt)
{
  ...
  // a static view template that is used to publish current view template
  ...
  // set the time, seq as header, record the id of the best matched template
...
int main(int argc, char * argv[])
{
  ...
  //publish the time, seq, and id of the view template matching to current image
