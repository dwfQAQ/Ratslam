...
/**
 * @brief store coordinate of related pose cell ? (pc_x, pc_y, pc_th), id of current view template, energy decay, related experiences exps[]
 * 
 */
...
/**
 * @brief store coordinate of related pose cell (x_pc, y_pc, th_pc) and corresponding view template (vt_id) of one experience node
 * 
 */
...
public:
  ...
  // these 
  /**
   * @brief return x coordinate of the most possible pose cell, updated by find_best()
   * 
   * @return best_x 
   */
  double x()
  ...
  /**
   * @brief return y coordinate of the most possible pose cell, updated by find_best()
   * 
   * @return best_y 
   */
  double y()
  ...
  /**
   * @brief return th coordinate of the most possible pose cell, updated by find_best()
   * 
   * @return best_th
   */
  double th()
